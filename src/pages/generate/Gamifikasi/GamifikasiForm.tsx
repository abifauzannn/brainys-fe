...
interface GamifikasiFormProps {
  onResult?: (text: string) => void;
  onLoadingChange?: (loading: boolean) => void;
  onGenerateId?: (id: string) => void;
}

const GamifikasiForm: React.FC<GamifikasiFormProps> = ({
  onResult,
  onLoadingChange,
  onGenerateId,
}) => {
  ...
  const [selectedSkema, setSelectedSkema] = useState<Option | null>(null);
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const payload = {
        name,
        game_scheme: selectedSkema?.value || "",
      ...
      const res = await api.post(`${API_URL}/gamification/generate`, payload);
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        ...
        <input
          type="text"
          placeholder="Masukkan nama gamifikasi"
          value={name}
      ...
      <div className="flex flex-col">
        ...
        <Select
          value={selectedSkema}
          onChange={(option) => setSelectedSkema(option)}
          options={skemaGamifikasi}
          styles={customSelectStyles}
      ...
      <div className="flex flex-col gap-2">
        ...
        >
          Deskripsi Gamifikasi
        </label>
        <textarea
          required
          id="notes"
          placeholder="Masukan deskripsi gamifikasi"
          value={notes}
          onChange={(e) => {
