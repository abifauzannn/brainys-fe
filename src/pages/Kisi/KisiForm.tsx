...
const KisiForm: React.FC<KisiFormProps> = ({
  onResult,
  onLoadingChange,
  onGenerateId,
}) => {
  ...
  const [jumlahSoal, setJumlahSoal] = useState<number | "">("");
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const payload = {
        ...
        elemen_capaian: selectedElement?.value || "",
        jumlah_soal: jumlahSoal,
        notes,
      };

      const res = await api.post(`${API_URL}/hint/generate`, payload);
